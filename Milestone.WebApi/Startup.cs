...
using Milestone.Dapper;
using Milestone.WebApi.Models;
using Milestone.WebApi.Unit;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Milestone API Interface Document",
                    Version = "v1",
                    Description = "RESTful API for Milestone",
                    TermsOfService = "None",
                    Contact = new Contact { Name = "lubin", Email = "lubin1998@hotmail.com", Url = "" }
                });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Milestone API V1");
            });
